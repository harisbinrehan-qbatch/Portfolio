      ...
      <div>
        <div className="card w-[90%] md:w-[45%] mx-auto">
          ...
          <div className="flex items-center justify-around gap-4 py-5">
            ...
            {myProject[0]?.githubServer && (
              <div
                onClick={handleServerLink}
                className="flex flex-col items-center hover:underline  cursor-pointer bg-slate-600 rounded-2xl py-4 px-5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="py-5">
            ...
            <figure className="py-1">
              <img src={myProject[0]?.infoImage4} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage5} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage6} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage7} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage8} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage9} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage10} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage11} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage12} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage13} alt="" />
            </figure>
            <figure className="py-1">
              <img src={myProject[0]?.infoImage14} alt="" />
            </figure>
          </div>
        </div>
      </div>
