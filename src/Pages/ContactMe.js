...
const ContactMe = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const from_name = formData.get("user_name");
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-evenly my-8">
              <div
                onClick={() => {
                  window.open("https://github.com/harisbinrehan");
                }}
              ...
              <div
                onClick={() => {
                  window.open("https://www.linkedin.com/in/harisbinrehan/");
                }}
              ...
              <div
                onClick={() => {
                  window.open("https://www.facebook.com/harisbinrehan/");
                }}
            ...
            <div>
              ...
              >
                ...
                <address>Johar Town, Lahore </address>
              </figure>
            </div>
          </div>
          <div
